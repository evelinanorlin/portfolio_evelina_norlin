...
const textObserver1 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in1', { opacity: 1, duration: 2, delay: 0.2});
    }
    else {
      gsap.to('.slide-in1', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver2 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in2', { opacity: 1, duration: 2, delay: 0.2})
    }     else {
      gsap.to('.slide-in2', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
  });
...
const textObserver3 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in3', { opacity: 1, duration: 2, delay: 0.2})
      console.log('hurra')
    }     
    else {
      gsap.to('.slide-in3', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver4 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in4', { opacity: 1, duration: 2, delay: 0.2})
    } 
    else {
      gsap.to('.slide-in4', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver5 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in5', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in5', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver6 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in6', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in6', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver7 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in7', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in7', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver8 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in8', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in8', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver9 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in9', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in9', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
...
const textObserver10 = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      gsap.to('.slide-in10', { opacity: 1, duration: 2, delay: 0.2})
    }
    else {
      gsap.to('.slide-in10', { opacity: 0, duration: 2, delay: 0.2});
    }
  });
});
